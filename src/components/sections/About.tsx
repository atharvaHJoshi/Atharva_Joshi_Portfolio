...
const DNA_NODES = [
  {
    ...
    items: ["Python", "C++", "Go", "FastAPI", "Flask", "Docker"],
    color: "text-blue-400",
  ...
  },
  {
    icon: Bot,
    label: "AI/ML & GENAI",
    items: ["LLMs", "RAG", "LoRA/PEFT", "YOLO", "TreeSHAP"],
  ...
  },
  {
    icon: Cpu,
    label: "CLOUD & INFRA",
    items: ["AWS S3", "EC2", "DynamoDB", "Linux", "Git"],
  ...
  },
  {
    icon: Globe,
    label: "ROBOTICS",
    items: ["ROS / ROS2", "MAVSDK/MAVLink", "LiDAR", "Embedded C++"],
  ...
  },
  {
    icon: Database,
    label: "DATA & BIG DATA",
    items: ["ETL", "Pandas", "Spark", "Feature Engineering"],
    color: "text-cyan-400",
  ...
  },
  {
    icon: Layers,
    label: "ARCHITECTURE",
    items: ["System Design", "REST APIs", "Microservices"],
    color: "text-rose-400",
